  ...
  return {
    ...
    */
    ...
    read_agregarFactibilidad(){
        return serviceURL + "FACTIBILIDAD/FACTIGIS/FeatureServer/0?f=json&token=" + token.read();
    },
    read_factigisUserProfile(){
      return serviceURL + "FACTIBILIDAD/FACTIGIS/FeatureServer/2?f=json&token=" + token.read();
    },
    read_factibilidad(){
        return serviceURL + "FACTIBILIDAD/FACTIGIS/MapServer?f=json&token=" + token.read();
    },
